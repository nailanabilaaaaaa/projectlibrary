        ...
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Book <b>{{$data->judul}}</b> </h4>
                                ...
                                <div class="form-group{{ $errors->has('lokasi') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="lokasi" required="">
                                            <option value="rak1" {{$data->lokasi === "rak1" ? "selected" : ""}}>Rak 1
                                            </option>
                                            <option value="rak2" {{$data->lokasi === "rak2" ? "selected" : ""}}>Rak 2
                                            </option>
                                            <option value="rak3" {{$data->lokasi === "rak3" ? "selected" : ""}}>Rak 3
                                            </option>
                                        </select>
                                    </div>
                                </div>
